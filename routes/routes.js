...
module.exports = (app)=>{
    ...
    app.get('/scrape', (req, res)=>{
        // get body of url
        axios.get('http://www.bbc.com/earth/columns/discoveries')
        .then((response)=>{
            // use cheerio for shorthand selector $
            let $ = cheerio.load(response.data);
            
            $('.promo-unit-copy-lining').each(function(i, element) {
                let result = {};
                const title = $(this).children('div').children('a').children('h3').text();
